...
const WHATSAPP_MESSAGE =
    'Ola! Vi o projeto "Sistema de Atendimento" no site da MALVSCODE e gostaria de conversar sobre algo parecido.';
...
function seed() {
    ...
    const profissionais = [
        { id: 'pr_1', nome: 'Mariana Alves',   contato: '(27) 99777-2001', usuario: 'mariana.alves', senha: 'demo123', especialidades: 'Consultoria, Suporte', disponibilidade: 'Seg a Sex - 08h-18h', status: 'ativo', observacoes: [] },
        { id: 'pr_2', nome: 'Rafael Teixeira', contato: '(27) 99777-2002', usuario: 'rafael.teixeira', senha: 'demo123', especialidades: 'Instalacao, Manutencao', disponibilidade: 'Seg a Sab - 09h-17h', status: 'ativo', observacoes: [] },
        { id: 'pr_3', nome: 'Juliana Prado',   contato: '(27) 99777-2003', usuario: 'juliana.prado', senha: 'demo123', especialidades: 'Atendimento geral', disponibilidade: 'Ter a Sex - 13h-19h', status: 'ativo', observacoes: [] }
    ];
    ...
    const agendamentos = [
        ...
        { id: 'ag_2', codigo: 'ME-0002', clienteId: 'ME-0003', clienteNome: 'Carla Menezes',     clienteContato: '(27) 99811-1003', clienteEmail: 'carla.menezes@exemplo.com', servicoNome: 'Instalacao Padrao',     profissionalId: 'pr_2', data: isoHoje,            hora: '14:00', status: 'agendado',  canalId: 'cn_2', observacoes: [] },
        { id: 'ag_3', codigo: 'ME-0003', clienteId: 'ME-0002', clienteNome: 'Bruno Cardoso',     clienteContato: '(27) 99811-1002', clienteEmail: 'bruno.cardoso@exemplo.com', servicoNome: 'Suporte Avancado',      profissionalId: 'pr_1', data: toDateInput(ontem), hora: '10:30', status: 'cancelado', canalId: 'cn_3', observacoes: [{ texto: 'Cliente avisou que nao podera comparecer.', autor: 'Recepcao', timestamp: nowISO() }] },
        { id: 'ag_4', codigo: 'ME-0004', clienteId: 'ME-0005', clienteNome: 'Eduarda Lopes',     clienteContato: '(27) 99811-1005', clienteEmail: 'eduarda.lopes@exemplo.com', servicoNome: 'Manutencao Preventiva', profissionalId: 'pr_2', data: toDateInput(amanha),hora: '11:00', status: 'agendado',  canalId: 'cn_1', observacoes: [] },
        { id: 'ag_5', codigo: 'ME-0005', clienteId: 'ME-0001', clienteNome: 'Ana Paula Ribeiro', clienteContato: '(27) 99811-1001', clienteEmail: 'ana.ribeiro@exemplo.com', servicoNome: 'Suporte Avancado',      profissionalId: 'pr_3', data: toDateInput(em3),   hora: '15:30', status: 'agendado',  canalId: 'cn_4', observacoes: [] },
    ...
    const atendimentos = agendamentos.map((ag, i) => ({
        ...
        canalId: ag.canalId,
        status: ag.status,
        observacoes: (ag.observacoes || []).slice()
    }));
    ...
    atendimentos.push({
        ...
        status: 'atendido',
        observacoes: [{ texto: 'Atendimento concluido com sucesso.', autor: 'Mariana Alves', timestamp: nowISO() }]
    });

    atendimentos.push({
        id: 'at_extra_2', agendamentoId: null, codigo: null,
        clienteId: null, clienteNome: 'Visitante - atendimento avulso',
        servicoNome: 'Instalacao Padrao', profissionalId: 'pr_2',
        data: toDateInput(ontem), hora: '13:00', canalId: 'cn_5',
        status: 'cancelado',
        observacoes: [{ texto: 'Cliente solicitou cancelamento.', autor: 'Recepcao', timestamp: nowISO() }]
    });

    const carla = clientes.find(c => c.id === 'ME-0003');
    carla.observacoes = [
        { texto: 'Atendimento concluido com sucesso.', autor: 'Mariana Alves', timestamp: nowISO() }
    ];

    const comunicacoes = [
        { id: 'co_1', clienteId: 'ME-0001', canalId: 'cn_1', assunto: 'Duvida sobre prazos',      status: 'aguardando', createdAt: new Date(Date.now() - 1000 * 60 * 60 * 5).toISOString(),  concluidoAt: null },
        { id: 'co_2', clienteId: 'ME-0004', canalId: 'cn_3', assunto: 'Solicitacao de orcamento', status: 'aguardando', createdAt: new Date(Date.now() - 1000 * 60 * 60 * 26).toISOString(), concluidoAt: null },
        ...
        { id: 'co_4', clienteId: 'ME-0005', canalId: 'cn_4', assunto: 'Confirmacao de cadastro',  status: 'atendido',   createdAt: new Date(Date.now() - 1000 * 60 * 60 * 48).toISOString(), concluidoAt: new Date(Date.now() - 1000 * 60 * 60 * 47).toISOString() },
        { id: 'co_5', clienteId: 'ME-0003', canalId: 'cn_1', assunto: 'Confirmacao de horario',   status: 'aguardando', createdAt: new Date(Date.now() - 1000 * 60 * 60 * 72).toISOString(), concluidoAt: null }
    ];
